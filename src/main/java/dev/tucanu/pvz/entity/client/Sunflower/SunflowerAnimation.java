package dev.tucanu.pvz.entity.client.Sunflower;// Save this class in your mod and generate all required imports
...
{
	public static final AnimationDefinition SUNFLOWER_GENERATE_SUN =
			AnimationDefinition.Builder.withLength(1.0834F)
