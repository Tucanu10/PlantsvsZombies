...
public class CeramicPotModel extends ArmorModel
{

	public CeramicPotModel(ModelPart root) {
		super(root);
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create(), PartPose.offset(-0.0452F, 0.9204F, 0.0F));

		PartDefinition pot_r1 = head.addOrReplaceChild("pot_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -2.0F, -6.0F, 12.0F, 7.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -9.0F, 0.0F, 0.0F, 0.0F, 0.1745F));

		PartDefinition handle_r1 = head.addOrReplaceChild("handle_r1", CubeListBuilder.create().texOffs(0, 19).addBox(-1.0F, -2.0F, -1.0F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -5.0F, 0.0F, 0.0F, 0.0F, 0.1745F));
